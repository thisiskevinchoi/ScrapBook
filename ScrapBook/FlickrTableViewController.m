...
- (id)initWithQuery:(NSString *)query
{
    ...
    if (self) {
        ...
        self.searcher = [[FlickrTagSearcher alloc] initWithTagQuery:query andTarget:self andAction:@selector(handleFlickrData:)];
    }
    return self;
}
...
- (void) handleFlickrData:(NSMutableDictionary *)data
{
    ...
    for (NSMutableDictionary *photo in photos) {
        ...
        NSString *url = [NSString stringWithFormat:@"http://farm%@.staticflickr.com/%@/%@_%@_z.jpg", farm, server, photoID, secret];
        ImageView* temp = [[ImageView alloc] initWithURL:[NSURL URLWithString:url]];
